...
- (SVPullToRefreshArrow *)arrow {
    if(!_arrow) {
        _arrow = [[SVPullToRefreshArrow alloc]initWithFrame:CGRectMake(0, self.bounds.size.height-54, 11, 24)];
...
- (void)drawRect:(CGRect)rect {
    ...
    CGContextAddRect(c, CGRectMake(2.5, 0, 6, 2)); // to-do: use dynamic points
    CGContextAddRect(c, CGRectMake(2.5, 3, 6, 2)); // currently fixed size: 22 x 48pt
    CGContextAddRect(c, CGRectMake(2.5, 6, 6, 2));
    CGContextAddRect(c, CGRectMake(2.5, 9, 6, 2));
    CGContextAddRect(c, CGRectMake(2.5, 12, 6, 2));
    CGContextAddRect(c, CGRectMake(2.5, 15, 6, 2));
    
    // the arrow
    CGContextMoveToPoint(c, 0, 17);
    CGContextAddLineToPoint(c, 5.5, 24);
    CGContextAddLineToPoint(c, 11, 17);
    CGContextAddLineToPoint(c, 0, 17);
